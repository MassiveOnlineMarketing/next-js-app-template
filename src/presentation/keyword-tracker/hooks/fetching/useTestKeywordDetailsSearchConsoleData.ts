...
function useTestKeywordDetailsSearchConsoleData(keywordName: string, googleSearchCampaign: GoogleSearchCampaign, hasAcces: boolean, refreshToken: string | null, gscUrl: string | null | undefined) {
  return useQuery({
...
export default useTestKeywordDetailsSearchConsoleData;